...
var handleSidebarMenu = function() {
	...
	$('body').on('click', '[data-click="sidebar-toggled"]', function(e) {
		e.preventDefault();
...
var handleSidebarMinifyFloatMenu = function() {
	$('body').on('click', '.float-sub-menu li.has-sub > a', function() {
		var target = $(this).next('.sub-menu');
		$(target).slideToggle(250, function() {
...
var handleDropdownClose = function() {
	$('body').on('click', '[data-dropdown-close="false"]', function(e) {
		e.stopPropagation();
	});
};
...
var handleAppNotification = function() {
	...
	$('body').on('click', '[data-toggle="notification"]', function(e) {
		e.preventDefault();
		var data = {
	...
	$('body').on('click', '[data-dismiss="notification"]', function(e) {
		e.preventDefault();
