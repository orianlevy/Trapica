...
export default class Premium extends React.Component {
    ...
    componentWillMount() {
        ...
        this.props.dispatch(setTitle("Premium"))
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-4">
                            <div styleName="price active">
                                ...
                                <a data-value="Premium" className="paypal-submit btn btn-primary" styleName="btn btn-primary">> Subscribe and start trial <i className="fa fa-chevron-right" aria-hidden="true"></i></a><br />
