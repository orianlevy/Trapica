...
componentWillMount() {
  ...
  this.props.dispatch(setTitle("Plans"))
      ...
      <div id="tr-pricing" styleName="tr-pricing image-bg section-padding">
        ...
        <div className="container text-center">
          ...
          <div styleName="section-info">
            <p>Target without technology is like driving without a wheel <br />Start now with 14 days of free trial </p>
          </div>
          <div className="row">
            <div className="col-sm-4">
              <div styleName="price">
                ...
                <a data-value="Premium" className="paypal-submit btn btn-primary" styleName="btn btn-primary">Subscribe and start trial<i className="fa fa-chevron-right" aria-hidden="true"></i></a>
              </div>
            </div>
            ...
            <div className="col-sm-4">
              <div styleName="price active">
                ...
                <a data-value="Business" className="paypal-submit btn btn-primary" styleName="btn btn-primary">Subscribe and start trial <i className="fa fa-chevron-right" aria-hidden="true"></i></a>
              </div>
            </div>
