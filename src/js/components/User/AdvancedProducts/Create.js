...
export default class Create extends React.Component {
  ...
  componentWillMount() {
    ...
    this.props.dispatch(setTitle("Create"))
        ...
        <div className="col-md-4">
          <div className="panel" styleName="panel panel-default">
              ...
              <div className="panel-body" styleName="panel-body">
                   <h3><span styleName="text-purple">Create</span></h3>
                   <p>Create is an advanced campaigns creation platform for enterprise users.<br/> 
